...
# Database: yiicms
# Generation Time: 2018-06-15 15:55:33 +0000
# ************************************************************
...
VALUES
	...
	(4,'去哪网',102,0,'','http://www.quna.com',0,0),
	(5,'携程',102,0,'','',0,0),
	(6,'马蜂窝',102,0,'','',0,0),
	(7,'面包旅行',102,0,'','',0,0);
...
VALUES
	(1,'出入料管理',NULL,'/backend/stream/index',0,X'7B2269636F6E22203A2266612066612D7468227D'),
	(2,'导入数据',1,'/backend/stream/create',1,NULL),
	(3,'出入料列表',1,'/backend/stream/index',0,NULL),
	...
	(31,'友情链接',14,'/backend/blogroll/index',8,NULL);
...
VALUES
	...
	('/backend/blogroll/*',2,NULL,NULL,NULL,1490367199,1490367199),
	('/backend/blogroll/create',2,NULL,NULL,NULL,1490367193,1490367193),
	('/backend/blogroll/delete',2,NULL,NULL,NULL,1490367197,1490367197),
	('/backend/blogroll/index',2,NULL,NULL,NULL,1490367188,1490367188),
	('/backend/blogroll/update',2,NULL,NULL,NULL,1490367195,1490367195),
	('/backend/blogroll/view',2,NULL,NULL,NULL,1490367191,1490367191),
	...
	('/backend/default/clear-cache',2,NULL,NULL,NULL,1490367249,1490367249),
	...
	('/backend/default/ueditor',2,NULL,NULL,NULL,1490367249,1490367249),
	('/backend/downloads/*',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/downloads/check',2,NULL,NULL,NULL,1490367249,1490367249),
	...
	('/backend/downloads/delete-all',2,NULL,NULL,NULL,1490367249,1490367249),
	('/backend/downloads/index',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/downloads/un-check',2,NULL,NULL,NULL,1490367249,1490367249),
	...
	('/backend/news/check',2,NULL,NULL,NULL,1490367231,1490367231),
	('/backend/news/create',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/news/delete',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/news/delete-all',2,NULL,NULL,NULL,1490367236,1490367236),
	('/backend/news/index',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/news/un-check',2,NULL,NULL,NULL,1490367233,1490367233),
	...
	('/backend/photos/check',2,NULL,NULL,NULL,1490367238,1490367238),
	('/backend/photos/create',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/photos/delete',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/photos/delete-all',2,NULL,NULL,NULL,1490367242,1490367242),
	('/backend/photos/delete-detail',2,NULL,NULL,NULL,1490367249,1490367249),
	...
	('/backend/photos/set-cover',2,NULL,NULL,NULL,1490367249,1490367249),
	('/backend/photos/un-check',2,NULL,NULL,NULL,1490367240,1490367240),
	...
	('/backend/products/check',2,NULL,NULL,NULL,1490367249,1490367249),
	...
	('/backend/products/delete-all',2,NULL,NULL,NULL,1490367249,1490367249),
	('/backend/products/index',2,NULL,NULL,NULL,1482896720,1482896720),
	('/backend/products/un-check',2,NULL,NULL,NULL,1490367249,1490367249),
	...
	('/backend/stream/create',2,NULL,NULL,NULL,1529046174,1529046174),
	('/backend/stream/delete',2,NULL,NULL,NULL,1529046176,1529046176),
	('/backend/stream/index',2,NULL,NULL,NULL,1529046168,1529046168),
	('/backend/stream/update',2,NULL,NULL,NULL,1529046179,1529046179),
	...
	('Visitor',1,'后台参观者','VisitorRule',NULL,1482897794,1528526398),
	('VisitorAccess',2,'浏览者权限，只读权限','VisitorRule',NULL,1482897866,1528526797),
	('管理员',1,'管理员',NULL,NULL,1528525434,1528527466);
...
INSERT INTO `category` (`id`, `name`, `pid`, `path`, `type`, `image`, `description`, `keywords`, `created_at`, `updated_at`)
VALUES
	(1,'游学研学',0,'',2,'','','',1481360463,1490457550),
	(2,'默认分类',0,'',1,'/uploads/products-img/img_58f32726aa3df.png','测试','测试，测试测试',1481367786,1492330278),
	(3,'新闻分类2',2,'2',1,'','','',1481372394,1499598678),
	(4,'旅行度假',0,'',2,'','','',1481609361,1490457573),
	(5,'下载文档',0,'',3,'','','',1482155225,1482155225),
	(6,'企业环境',0,'',4,'','','',1482559711,1482559711),
	(7,'商务考察',0,'',2,'','','',1490457590,1490457590),
	(8,'测试修改path',0,'',1,'','','',1498831600,1498833499),
	(9,'测试修改path2',3,'',1,'','','',1498832464,1499598673),
	(10,'修改path3',9,'9',1,'','','',1498832583,1499598673);
...
VALUES
	(2,'contact_us','联系我们','<p>公司: 在北京网络科技</p><p>联系人: 李sss</p><p>QQ: 739800600</p><p>电话: 1304351</p><p>E-mail: 739800600@qq.com</p><p>地址: 北京市丰台区大红门</p>',1481350005,1482902162),
	(3,'contact_us_page_id','联系我们','1',1481355647,1483169811),
	(4,'jianjie','企业简介','北京雄鹰国际旅行社是新时代投资管理集团旗下的专业旅游平台,依托集团广泛而强大的资源和团队，雄鹰国旅专注于游学交流，商务考察，专项旅行，帆船体验，机票代理等，致力于通过旅行提高青少年的品格与素养，为旅行者提供专业化，个性化的优质服务testtesttest',1490458199,1490458199),
	(5,'gongyi','公益广告','<script type=\"text/javascript\"> var yibo_id =40276;</script><script src=\"http://yibo.iyiyun.com/yibo.js?random=309727\" type=\"text/javascript\"></script>',1494309812,1494309845),
	(6,'top_right_data','头部右侧数据','电话:13240702278,17346512591',1507598988,1507598988);
...
INSERT INTO `content` (`id`, `title`, `type`, `category_id`, `image`, `description`, `keywords`, `status`, `admin_user_id`, `hits`, `created_at`, `updated_at`)
VALUES
	...
	(22,'测试测试测试',2,1,'/uploads/products-img/img_584d57438ddb0.jpg','测试测试测试','',1,1,0,1481463619,1481463619),
	(23,'测试产品22222222222222',2,1,'/uploads/products-img/img_584d5d65a0855.jpg','测试产品','',1,1,0,1481465189,1481465189),
	(24,'飒飒的范德萨范德萨似懂非懂是',2,1,'/uploads/products-img/img_58575c9b83b7b.png','<p>似懂非懂是付的是</p><p><br></p>','',1,1,1,1481465708,1482120751),
	(25,'美国代购2016 MOTHER 女士磨边牛仔裤',2,1,'/uploads/products-img/img_584eb27571659.jpg','重度磨损和猫须褶皱为这款褪色 MOTHER 牛仔裤带来做旧效果。5 口袋设计。钮扣和拉链门襟。','',1,1,6,1481552501,1481552688),
	(26,'关于公司考勤制度',3,5,'','<p>关于公司考勤制度</p>','',1,1,28,1482155706,1482157422),
	(27,'测试',3,5,'','','',0,1,0,1482200020,1482202904),
	(29,'产品继承测试',2,1,'/uploads/products-img/img_5859f8c6724c8.jpg','','',1,1,23,1482291398,1482325074),
	(30,'办公环境',4,6,'','','',1,1,8,1482560413,1482560413),
	(31,'测试相册',4,6,'','测试','测试',1,1,0,1482654720,1482654720),
	(32,'cccc',3,5,'','','ssss',0,1,0,1489731591,1494326191),
	(33,'测试测试',2,1,'/uploads/products-img/img_59119bdcd73a2.jpg','ddddd','fffff',0,1,0,1494325122,1510469150);
...
VALUES
	...
	(39,32,'<p>ssss</p>','','/uploads/downloads/yiicms58cb8007d61e7.rar',1489731591,1489731591),
	(40,33,'<p>是打发第三方</p>','<p>胜多负少订单上</p>','',1494325122,1494325122);
...
VALUES
	...
	(3,'sddfsfsfds','dsfsdfsdds','','739800600@qq.com','sdfdsfds',1501242456,1501242456),
	(4,'ddddddd','ddddd','','739800600@qq.com','dsfsdfds',1501242645,1501242645),
	(5,'dsfsdfdsfsd','dddd','','739800600@qq.com','dsfsdfdsfds',1501397774,1501397774);
...
VALUES
	('m140209_132017_init',1494032883),
	('m140403_174025_create_account_table',1494032883),
	('m140504_113157_update_tables',1494032884),
	('m140504_130429_create_token_table',1494032884),
	('m140506_102106_rbac_init',1482895903),
	('m140830_171933_fix_ip_field',1494032884),
	('m140830_172703_change_account_table_name',1494032884),
	('m141222_110026_update_ip_field',1494032884),
	('m141222_135246_alter_username_length',1494032884),
	('m150614_103145_update_social_account_table',1494032884),
	('m150623_212711_fix_username_notnull',1494032884),
	('m151218_234654_add_timezone_to_profile',1494032884),
	('m160929_103127_add_last_login_at_to_user_table',1494032884);
...
CREATE TABLE `stream` (
  ...
  `uid` varchar(50) NOT NULL DEFAULT '' COMMENT '索引',
  `type` varchar(6) NOT NULL DEFAULT '' COMMENT '类型',
  `start_time` int(11) unsigned zerofill NOT NULL COMMENT '开始时间',
  `end_time` int(11) unsigned zerofill NOT NULL COMMENT '结束时间',
  `start_weight` decimal(10,2) unsigned zerofill NOT NULL COMMENT '起始量',
  `end_weight` decimal(10,2) unsigned zerofill NOT NULL COMMENT '结束量',
  `the_weight` decimal(10,2) unsigned zerofill NOT NULL COMMENT '本次出/入量',
  `total_weight` int(11) unsigned zerofill NOT NULL COMMENT '累计出/入量',
  `property_no` varchar(50) NOT NULL DEFAULT '' COMMENT '资产号',
  `well_no` varchar(50) NOT NULL DEFAULT '' COMMENT '井号',
  `team_no` varchar(50) NOT NULL DEFAULT '' COMMENT '队号',
  `well_class` varchar(50) NOT NULL DEFAULT '' COMMENT '钻井队',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_uid` (`uid`),
  KEY `index_type` (`type`),
  KEY `index_property` (`property_no`),
  KEY `index_well` (`well_no`),
  KEY `index_team` (`team_no`),
  KEY `index_class` (`well_class`),
  KEY `key3_type_well_team` (`type`,`well_no`,`team_no`),
  KEY `order_start_time` (`start_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `stream` WRITE;
/*!40000 ALTER TABLE `stream` DISABLE KEYS */;

INSERT INTO `stream` (`id`, `uid`, `type`, `start_time`, `end_time`, `start_weight`, `end_weight`, `the_weight`, `total_weight`, `property_no`, `well_no`, `team_no`, `well_class`)
VALUES
	(1,'wx_3sc0slxhg','出料',00000000000,00000000000,00000000.00,00000000.00,00000000.00,00000000000,'罐子1','川A0808','钻井队1','东华公司'),
	(2,'wdqefregresg','进料',00000000000,00000000000,00000000.00,00000000.00,00000000.00,00000000000,'','','','');

/*!40000 ALTER TABLE `stream` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table stream_type
# ------------------------------------------------------------
